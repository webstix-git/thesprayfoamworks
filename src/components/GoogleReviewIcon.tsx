type GoogleReviewIconProps = {
  className?: string;
  size?: number;
};

export function GoogleReviewIcon({ className, size = 24 }: GoogleReviewIconProps) {
  return (
    <svg
      className={className}
      width={size}
